    ...
    const getPrioritizeUnplayedDescription = () => {
        if (generationMode === 'random') {
            return prioritizeUnplayed
                ? "Герои выбираются случайно, но те, кто давно не играл или часто отдыхал в последнее время, имеют гораздо больше шансов выпасть, чем недавно игравшие персонажи."
        ...
        if (generationMode === 'balanced') {
            return prioritizeUnplayed
                ? "Приоритет учитывается при первом подборе героев и при балансирующих заменах. Система сохранит равные силы команд, но предпочтет выдать вам редко играющих персонажей."
                : "Включите эту опцию, чтобы при поиске равных команд алгоритм в первую очередь предлагал давно неигравших героев.";
        }
        // Strict mode (Лимит)
        return prioritizeUnplayed
            ? "При поиске сбалансированного состава (до 200 попыток) система генерирует четверки на основе весов истории. Вы получите равные команды, состоящие преимущественно из давно неигравших героев."
            : "Включите эту опцию, чтобы система подбирала сбалансированный по силе состав в первую очередь из редко играющих персонажей.";
    };
