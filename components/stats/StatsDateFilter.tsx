...
export const StatsDateFilter: React.FC<StatsDateFilterProps> = ({
    ...
    return (
        <div className="shrink-0 bg-transparent select-none">
            <div
            ...
            >
                <div className="overflow-hidden">
                    <div className="p-4 bg-white/30 dark:bg-slate-950/30 backdrop-blur-xl border-b border-slate-200/40 dark:border-slate-800/40 space-y-3.5">
