  ...
  return (
    <div className={`fixed inset-0 z-50 bg-slate-50 dark:bg-slate-950 flex flex-col transition-all duration-300 ease-in-out ${isOpen ? 'translate-x-0 opacity-100 visible' : 'translate-x-full opacity-0 invisible'}`}>
      ...
      <div className="flex-1 relative overflow-hidden" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
          ...
          <div className="pb-safe-area-bottom">
            ...
            {activeTab === 'info' && (
              <div className="flex flex-col items-center justify-center h-full p-6 text-center animate-in fade-in slide-in-from-bottom-2">
                 ...
                 <div onClick={handleVersionClick} className="relative cursor-pointer inline-block mb-8"> <p className="text-sm font-bold text-primary-500 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 px-3 py-1 rounded-full select-none">v2.2.3</p> {!isDebugMode && debugClicks > 5 && debugClicks < 10 && ( <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 whitespace-nowrap text-[10px] font-bold text-slate-400"> Debug через {10 - debugClicks}... </div> )} </div>
        ...
        {/* ... (Portals and Modals remain mostly unchanged, just ensured they are present and correct) */}
        {/* Editor Menu Portal */}
